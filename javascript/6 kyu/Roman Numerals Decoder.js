...
// "MCMXC" (1000 = M, 900 = CM, 90 = XC) and 2008 is rendered "MMVIII" (2000 = MM, 8 = VIII). The Roman numeral for 1666, "MDCLXVI", uses each letter in descending order.
...
function solution(roman) {
  ...
  for (let i = 0; i < roman.length; i++) {
    if (romanNumbers[roman[i + 1]] > romanNumbers[roman[i]]) {
